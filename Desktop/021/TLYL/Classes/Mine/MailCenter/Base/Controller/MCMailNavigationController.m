...
@interface MCMailNavigationController ()

@end

@implementation MCMailNavigationController
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated{
    ...
    if ( self.childViewControllers.count == 0) {
        ...
        if ([viewController isKindOfClass:[MCChoiceMesPersonViewController class]]||[viewController isKindOfClass:[MCInBoxDetailViewController class]] ||[MCKefuViewController class]) {
