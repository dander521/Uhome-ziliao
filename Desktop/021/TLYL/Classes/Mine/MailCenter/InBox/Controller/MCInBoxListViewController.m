...
@interface MCInBoxListViewController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic,weak) UITableView *tableView;

@property (nonatomic,strong) NSMutableArray *tableViewDataArray;

@property (nonatomic,strong) MCEmailListModel *listModel;

@property (nonatomic,assign) int currentPageIndex;

@end

@implementation MCInBoxListViewController
...
-(void)loadListData{
    ...
    MCEmailListModel *listModel = [[MCEmailListModel alloc] init];
    ...
    listModel.callBackSuccessBlock = ^(NSDictionary *manager) {
        ...
        if ([manager.allKeys containsObject:@"EmailReceiveBoxs"]) {
            weakself.tableViewDataArray = [MCEmailListModel mj_objectArrayWithKeyValuesArray:manager[@"EmailReceiveBoxs"]];
        }
...
- (void)loadMoreData{
    ...
    self.listModel.callBackSuccessBlock = ^(id manager) {
        [weakSelf tableViewEndRefreshing];
        NSArray *arr = [MCEmailListModel mj_objectArrayWithKeyValuesArray:manager[@"EmailReceiveBoxs"]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    MCEmailListModel *model = self.tableViewDataArray[indexPath.row];
    MCInBoxDetailViewController *vc = [[MCInBoxDetailViewController alloc] init];
    vc.ID = model.ID;
