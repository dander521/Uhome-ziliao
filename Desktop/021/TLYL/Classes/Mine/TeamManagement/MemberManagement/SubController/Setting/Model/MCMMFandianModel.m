...
@interface MCMMFandianModel ()<ApiManagerCallBackProtocol,ApiManagerProvider,ApiManagerProtocol>


@end

@implementation MCMMFandianModel
...
- (NSString *)urlPathComponentForManagerWithManager:(ApiBaseManager *)manager{
    ...
    return @"web-api/api/v4/sub_upgrade_rebate";
}
...
- (NSDictionary<NSString *,id> *)parametersForManagerWithManager:(ApiBaseManager *)manager{
    ...
    NSDictionary *dic =@{@"LikeUserName":self.LikeUserName,@"IsP":[NSNumber numberWithInt:self.IsP]};
