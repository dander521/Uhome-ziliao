...
@implementation MCPIRefreshNormalHeader
...
- (void)placeSubviews{
    ...
    //箭头
    self.stateLabel.mj_y = self.stateLabel.mj_y - MC_REALVALUE(13 + 96);
    self.lastUpdatedTimeLabel.mj_y = self.lastUpdatedTimeLabel.mj_y - MC_REALVALUE(13 + 96);
    self.arrowView.mj_y =  self.arrowView.mj_y - MC_REALVALUE(13 + 96);
}
