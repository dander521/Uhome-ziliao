...
@class MGBaseSwipeTableViewCell;
 ...
 */
@protocol MGBaseSwipeTableViewCellDelegate <NSObject>
 ...
 **/
-(BOOL) swipeTableCell:(nonnull MGBaseSwipeTableViewCell*) cell canSwipe:(MGSwipeDirection) direction fromPoint:(CGPoint) point;
-(BOOL) swipeTableCell:(nonnull MGBaseSwipeTableViewCell*) cell canSwipe:(MGSwipeDirection) direction DEPRECATED_ATTRIBUTE; //backwards compatibility
 ...
 **/
-(void) swipeTableCell:(nonnull MGBaseSwipeTableViewCell*) cell didChangeSwipeState:(MGSwipeState) state gestureIsActive:(BOOL) gestureIsActive;

/**
 * Called when the user clicks a swipe button or when a expandable button is automatically triggered
 * @return YES to autohide the current swipe buttons
 **/
-(BOOL) swipeTableCell:(nonnull MGBaseSwipeTableViewCell*) cell tappedButtonAtIndex:(NSInteger) index direction:(MGSwipeDirection)direction fromExpansion:(BOOL) fromExpansion;
/**
 ...
 **/
-(nullable NSArray<UIView*>*) swipeTableCell:(nonnull MGBaseSwipeTableViewCell*) cell swipeButtonsForDirection:(MGSwipeDirection)direction
 ...
 * @return YES to autohide the current swipe buttons
 **/
-(BOOL) swipeTableCell:(nonnull MGBaseSwipeTableViewCell *)cell shouldHideSwipeOnTap:(CGPoint) point;

/**
 * Called when the cell will begin swiping
 * Useful to make cell changes that only are shown after the cell is swiped open
 **/
-(void) swipeTableCellWillBeginSwiping:(nonnull MGBaseSwipeTableViewCell *) cell;

/**
 * Called when the cell will end swiping
 **/
-(void) swipeTableCellWillEndSwiping:(nonnull MGBaseSwipeTableViewCell *) cell;
...
@interface MGBaseSwipeTableViewCell : UITableViewCell
...
@property (nonatomic, weak, nullable) id<MGBaseSwipeTableViewCellDelegate> delegate;
 ...
 * @param usingDelegate if YES new buttons will be fetched using the MGBaseSwipeTableViewCellDelegate. Otherwise new buttons will be fetched from leftButtons/rightButtons properties.
 */
