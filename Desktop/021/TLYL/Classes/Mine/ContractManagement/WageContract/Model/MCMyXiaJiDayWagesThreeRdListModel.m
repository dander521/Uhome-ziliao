//
//  MCMyXiaJiDayWagesThreeRdListModel.m
//  TLYL
//
...
//查看下级的日工资列表 （日工资3）
@interface MCMyXiaJiDayWagesThreeRdListModel ()<ApiManagerCallBackProtocol,ApiManagerProvider,ApiManagerProtocol>
{
...
@implementation MCMyXiaJiDayWagesThreeRdListModel
...
- (NSString *)urlPathComponentForManagerWithManager:(ApiBaseManager *)manager{
    ...
    return @"web-api/api/v4/get_daywages_3rd";
...
- (void)managerCallAPIDidFailedWithManager:(ApiBaseManager *)manager errorCode:(NSString *)errorCode{
    ...
    NSLog(@"er=--web-api/api/v4/get_daywages_3rd--%@",errorCode);
}
...
@implementation MCMyXiaJiDayWagesThreeRdListDataModel
+(NSDictionary *)objectClassInArray
{
    return @{
             @"DayWagesThreeListModels" : [MCMyXiaJiDayWagesThreeListModelsDataModel class]
...
@implementation MCMyXiaJiDayWagesThreeListModelsDataModel
- (void)setValue:(id)value forUndefinedKey:(NSString *)key{
