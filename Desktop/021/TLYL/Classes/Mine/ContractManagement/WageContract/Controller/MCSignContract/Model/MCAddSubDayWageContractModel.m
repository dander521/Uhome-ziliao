//
//  MCAddSubDayWageContractModel.m
//  TLYL
//
...
//添加下级的日工资契约 （日工资3）
@interface MCAddSubDayWageContractModel ()<ApiManagerCallBackProtocol,ApiManagerProvider,ApiManagerProtocol>
{
...
@implementation MCAddSubDayWageContractModel
...
- (NSString *)urlPathComponentForManagerWithManager:(ApiBaseManager *)manager{
    ...
    return @"web-api/api/v4/add_sub_daywages_3rd";
...
- (void)managerCallAPIDidFailedWithManager:(ApiBaseManager *)manager errorCode:(NSString *)errorCode{
    ...
    NSLog(@"er=--web-api/api/v4/add_sub_daywages_3rd--%@",errorCode);
}
