...
@interface MCWageRecordSlideView ()
...
@implementation MCWageRecordSlideView
...
-(void)createUICollectionView
{
    ...
    [_collectionView registerClass:[MCWageRecordXiaJiCollectionViewCell class]  forCellWithReuseIdentifier:NSStringFromClass([MCWageRecordXiaJiCollectionViewCell class]) ];
    
    [_collectionView registerClass:[MCWageRecordMySelfCollectionViewCell class] forCellWithReuseIdentifier:NSStringFromClass([MCWageRecordMySelfCollectionViewCell class])];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row==0)
    {
        MCWageRecordXiaJiCollectionViewCell *cell=[collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass([MCWageRecordXiaJiCollectionViewCell class]) forIndexPath:indexPath];
        _xiaJiCell=cell;
        return cell;
        //汇总
    }else {
        
        MCWageRecordMySelfCollectionViewCell *cell=[collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass([MCWageRecordMySelfCollectionViewCell class]) forIndexPath:indexPath];
        _mySelfCell=cell;
        return cell;
    }
