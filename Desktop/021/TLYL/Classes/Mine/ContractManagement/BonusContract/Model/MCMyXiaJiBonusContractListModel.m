//
//  MCMyXiaJiBonusContractListModel.m
//  TLYL
//
...
@interface MCMyXiaJiBonusContractListModel ()<ApiManagerCallBackProtocol,ApiManagerProvider,ApiManagerProtocol>
{
...
@implementation MCMyXiaJiBonusContractListModel
...
- (NSString *)urlPathComponentForManagerWithManager:(ApiBaseManager *)manager{
    ...
    return @"web-api/api/v4/get_contract";
...
@implementation MCMyXiaJiBonusContractListDataModel
+(NSDictionary *)objectClassInArray
{
    return @{
             @"ContractManagerModels" : [MCMyXiaJiBonusContractListDeatailDataModel class]
...
@implementation MCMyXiaJiBonusContractListDeatailDataModel
- (void)setValue:(id)value forUndefinedKey:(NSString *)key{
