...
@interface MCResetLoginPwdModel ()<ApiManagerCallBackProtocol,ApiManagerProvider,ApiManagerProtocol>
...
@implementation MCResetLoginPwdModel
...
- (NSString *)urlPathComponentForManagerWithManager:(ApiBaseManager *)manager{
    ...
    return @"web-api/api/v4/reset_login_pwd";
...
- (void)managerCallAPIDidFailedWithManager:(ApiBaseManager *)manager errorCode:(NSString *)errorCode{
    ...
    NSLog(@"er=--web-api/api/v4/reset_login_pwd--%@",errorCode);
}
