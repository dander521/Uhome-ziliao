...
@interface MCEmailCountModel ()<ApiManagerCallBackProtocol,ApiManagerProvider,ApiManagerProtocol>


@end

@implementation MCEmailCountModel
...
- (NSString *)urlPathComponentForManagerWithManager:(ApiBaseManager *)manager{
    ...
    return @"web-api/api/v4/email_unread_count";
}
...
- (NSDictionary<NSString *,id> *)parametersForManagerWithManager:(ApiBaseManager *)manager{
    ...
    dic =@{@"UserID":[[NSUserDefaults standardUserDefaults] objectForKey:@"userId"]};
