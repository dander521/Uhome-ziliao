...
@interface MCRegisterSubbyLinkModel ()<ApiManagerCallBackProtocol,ApiManagerProvider,ApiManagerProtocol>


@end

@implementation MCRegisterSubbyLinkModel
...
- (NSString *)urlPathComponentForManagerWithManager:(ApiBaseManager *)manager{
    ...
    return @"web-api/api/v4/register_sub_by_link";
}

- (NSDictionary<NSString *,id> *)parametersForManagerWithManager:(ApiBaseManager *)manager{
    
    NSString *timeString = [NSString getCurrentTimestamp];
    NSDictionary *dic =@{@"Rebate":[NSNumber numberWithInt:self.Rebate],@"IsAgent":[NSNumber numberWithBool:self.IsAgent],@"TeamName":self.TeamName,@"QQ":self.QQ};
