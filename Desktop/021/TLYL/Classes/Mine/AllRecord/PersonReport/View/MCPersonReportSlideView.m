...
@interface MCPersonReportSlideView ()
...
@implementation MCPersonReportSlideView
...
-(void)createUICollectionView
{
    ...
    [_collectionView registerClass:[MCDailyReportCollectionViewCell class]  forCellWithReuseIdentifier:NSStringFromClass([MCDailyReportCollectionViewCell class]) ];
    
    [_collectionView registerClass:[MCSummaryReportCollectionViewCell class] forCellWithReuseIdentifier:NSStringFromClass([MCSummaryReportCollectionViewCell class])];
...
//    __weak __typeof__ (self) wself = self;
    ...
    if (indexPath.row==0)
    {
        MCDailyReportCollectionViewCell *cell=[collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass([MCDailyReportCollectionViewCell class]) forIndexPath:indexPath];
        _dailyCell=cell;
        return cell;
        //汇总
    }else {
        
        MCSummaryReportCollectionViewCell *cell=[collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass([MCSummaryReportCollectionViewCell class]) forIndexPath:indexPath];
        _summaryCell=cell;
        return cell;
    }
