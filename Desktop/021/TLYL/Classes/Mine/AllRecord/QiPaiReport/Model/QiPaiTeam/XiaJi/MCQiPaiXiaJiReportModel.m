...
@interface MCQiPaiXiaJiReportModel ()<ApiManagerCallBackProtocol,ApiManagerProvider,ApiManagerProtocol>
{
...
@implementation MCQiPaiXiaJiReportModel
...
- (NSString *)urlPathComponentForManagerWithManager:(ApiBaseManager *)manager{
    ...
    return @"web-api/api/v4/game_team_report_sub";
...
@implementation MCQiPaiXiaJiReportDataModel
+(NSDictionary *)objectClassInArray
{
    return @{
             @"ReportComm" : [MCQiPaiXiaJiReportCommModel class]
             };
}
- (void)setValue:(id)value forUndefinedKey:(NSString *)key{
...
@implementation MCQiPaiXiaJiReportCommModel
