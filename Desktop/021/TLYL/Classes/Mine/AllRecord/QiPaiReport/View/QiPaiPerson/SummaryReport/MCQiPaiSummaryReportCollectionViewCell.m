//
//  MCQiPaiSummaryReportCollectionViewCell.m
//  TLYL
//
...
#import "MCQiPaiSummaryReportTableViewCell.h"
#import "MCQiPaiPersonSlideView.h"

#define MORENCOUNT 15
@interface MCQiPaiSummaryReportCollectionViewCell()
<
UITableViewDelegate,
...
@implementation MCQiPaiSummaryReportCollectionViewCell
...
-(void)setData:(NSDictionary *)dic{
    ...
    [_dataMarray addObjectsFromArray:_Gmodel.ReportComm];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    return [MCQiPaiSummaryReportTableViewCell computeHeight:nil];
}


- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    
    NSString *reuseIdentifier =[NSString stringWithFormat:@"MCQiPaiSummaryReportTableViewCell-%ld-%ld",(long)indexPath.section,(long)indexPath.row];
    MCQiPaiSummaryReportTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:reuseIdentifier];
    if (!cell) {
        cell = [[MCQiPaiSummaryReportTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseIdentifier];
