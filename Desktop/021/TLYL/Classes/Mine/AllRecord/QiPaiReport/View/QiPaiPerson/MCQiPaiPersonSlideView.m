...
@implementation MCQiPaiPersonProperty
singleton_m(MCQiPaiPersonProperty)

@end

@interface MCQiPaiPersonSlideView ()
...
@implementation MCQiPaiPersonSlideView
...
//        vc.Type=MCQiPai_Person_DailyReport;
//    }else{
//        MCQiPaiReportViewController * vc =(MCQiPaiReportViewController *)[UIView MCcurrentViewController];
//        vc.Type=MCQiPai_Person_SummaryReport;
//    }
...
-(void)createUICollectionView
{
    ...
    [_collectionView registerClass:[MCQiPaiDailyReportCollectionViewCell class]  forCellWithReuseIdentifier:NSStringFromClass([MCQiPaiDailyReportCollectionViewCell class]) ];
    
    [_collectionView registerClass:[MCQiPaiSummaryReportCollectionViewCell class] forCellWithReuseIdentifier:NSStringFromClass([MCQiPaiSummaryReportCollectionViewCell class])];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row==0)
    {
        MCQiPaiDailyReportCollectionViewCell *cell=[collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass([MCQiPaiDailyReportCollectionViewCell class]) forIndexPath:indexPath];
        _dailyCell=cell;
        return cell;
        //汇总
    }else {
        
        MCQiPaiSummaryReportCollectionViewCell *cell=[collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass([MCQiPaiSummaryReportCollectionViewCell class]) forIndexPath:indexPath];
        _summaryCell=cell;
        return cell;
    }
