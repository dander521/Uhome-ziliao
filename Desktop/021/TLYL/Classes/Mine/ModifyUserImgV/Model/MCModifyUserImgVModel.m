...
@interface MCModifyUserImgVModel ()<ApiManagerCallBackProtocol,ApiManagerProvider,ApiManagerProtocol>
{
...
@implementation MCModifyUserImgVModel
singleton_m(MCModifyUserImgVModel)
...
- (NSString *)urlPathComponentForManagerWithManager:(ApiBaseManager *)manager{
    ...
    return @"web-api/api/v4/modify_head_icon";
...
@implementation MCUserImgVModel
