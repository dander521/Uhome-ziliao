...
@interface MCModifySubTypeModel ()<ApiManagerCallBackProtocol,ApiManagerProvider,ApiManagerProtocol>


@end

@implementation MCModifySubTypeModel
...
- (NSString *)urlPathComponentForManagerWithManager:(ApiBaseManager *)manager{
    ...
    return @"web-api/api/v4/modify_sub_type";
}
...
- (NSDictionary<NSString *,id> *)parametersForManagerWithManager:(ApiBaseManager *)manager{
    ...
    NSDictionary *dic =@{@"subUserID":[NSNumber numberWithInt:self.subUserID],@"Type":[NSNumber numberWithInt:self.Type]};
