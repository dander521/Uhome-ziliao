...
@interface MCEmailReceiverModel ()<ApiManagerCallBackProtocol,ApiManagerProvider,ApiManagerProtocol>


@end

@implementation MCEmailReceiverModel
...
- (NSString *)urlPathComponentForManagerWithManager:(ApiBaseManager *)manager{
    ...
    return @"web-api/api/v4/email_all_receiver";
}

- (NSDictionary<NSString *,id> *)parametersForManagerWithManager:(ApiBaseManager *)manager{
    
    NSString *timeString = [NSString getCurrentTimestamp];
    NSDictionary *dic =@{@"Sendid":self.Sendid,@"CurrentPageIndex":[NSNumber numberWithInt:self.CurrentPageIndex],@"CurrentPageSize":[NSNumber numberWithInt:self.CurrentPageSize]};
