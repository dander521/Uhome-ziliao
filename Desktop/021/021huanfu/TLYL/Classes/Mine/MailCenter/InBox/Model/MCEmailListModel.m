...
@interface MCEmailListModel ()<ApiManagerCallBackProtocol,ApiManagerProvider,ApiManagerProtocol>


@end

@implementation MCEmailListModel
...
- (NSDictionary<NSString *,id> *)parametersForManagerWithManager:(ApiBaseManager *)manager{
    ...
    NSDictionary *dic =@{@"UserID":self.UserID,@"CurrentPageIndex":[NSNumber numberWithInt:self.CurrentPageIndex],@"CurrentPageSize":[NSNumber numberWithInt:self.CurrentPageSize]};
