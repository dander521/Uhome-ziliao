...
@interface MCGameRecordTableViewCell()
...
@implementation MCGameRecordTableViewCell
...
- (void)setDataSource:(MCGameRecordModel *)dataSource{
    _dataSource = dataSource;
    self.qihaoLabel.text = [NSString stringWithFormat:@"%@期",dataSource.IssueNumber];
//    NSDateFormatter *dataFormatter = [[NSDateFormatter alloc] init];
////    2017-08-29 16:45:55
//    [dataFormatter setDateFormat:@"yyyy/MM/dd HH:mm:ss"];
//    NSDate *date = [dataFormatter dateFromString:dataSource.InsertTime];
//    NSDateFormatter *dataFormatter1 = [[NSDateFormatter alloc] init];
//    // 16:45
//    [dataFormatter1 setDateFormat:@"HH:mm"];
