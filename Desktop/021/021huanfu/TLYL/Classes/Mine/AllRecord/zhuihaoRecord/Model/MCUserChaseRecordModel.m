...
@interface MCUserChaseRecordModel ()<ApiManagerCallBackProtocol,ApiManagerProvider,ApiManagerProtocol>
{
...
@implementation MCUserChaseRecordModel
...
- (NSString *)urlPathComponentForManagerWithManager:(ApiBaseManager *)manager{
    ...
    return @"web-api/api/v4/user_chase_record";
...
@implementation MCUserChaseRecordDataModel
- (void)setValue:(id)value forUndefinedKey:(NSString *)key{
