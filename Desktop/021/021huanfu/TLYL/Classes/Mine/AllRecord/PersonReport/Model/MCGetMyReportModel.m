...
@interface MCGetMyReportModel ()<ApiManagerCallBackProtocol,ApiManagerProvider,ApiManagerProtocol>
{
...
@implementation MCGetMyReportModel
...
- (NSString *)urlPathComponentForManagerWithManager:(ApiBaseManager *)manager{
    ...
    return @"web-api/api/v4/get_my_report";
...
@implementation MCGetMyReportDataModel
+(NSDictionary *)objectClassInArray
{
    return @{
             @"Reportlst" : [MCGetMyReportlstModel class],
             @"ReportComm" : [MCGetMyReportCommModel class]
             };
}
...
@implementation MCGetMyReportlstModel
- (void)setValue:(id)value forUndefinedKey:(NSString *)key{
...
@implementation MCGetMyReportCommModel
- (void)setValue:(id)value forUndefinedKey:(NSString *)key{
