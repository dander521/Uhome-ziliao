//
//  MCSummaryReportTableViewCell.m
//  TLYL
//
...
@interface MCSummaryReportTableViewCell ()
...
@implementation MCSummaryReportTableViewCell
...
-(void)setDataSource:(MCGetMyReportCommModel *)dataSource{
    ...
    //充值总额：20000.00
    _chongzhiMoneyLabel.text=dataSource.RechargeTotal;
    //购彩总额：20000.00
    _caiGouMoney.text=dataSource.BuyTotal;
    //自身返点：1956～0.0
    _myRebate.text=dataSource.SelfRebateTotal;
    //其他收入：2000.00
    _otherMoney.text=dataSource.OtherTotal;
    //提款总额：20000.00
    _withdrawMoney.text=dataSource.DrawingsTotal;
    //奖金总额：20000.00
    _jiangJinMoney.text=dataSource.WinningTotal;
    //下级返点：1956～0.0
    _xiaJiRebateMoney.text=dataSource.SubRebateTotal;
    //盈利总额：200000.00
    _yinLiMoney.text=dataSource.GainTotal;
