...
@interface MCQiPaiTeamReportModel ()<ApiManagerCallBackProtocol,ApiManagerProvider,ApiManagerProtocol>
{
...
@implementation MCQiPaiTeamReportModel
...
@implementation MCQiPaiTeamReportDataModel
- (void)setValue:(id)value forUndefinedKey:(NSString *)key{
