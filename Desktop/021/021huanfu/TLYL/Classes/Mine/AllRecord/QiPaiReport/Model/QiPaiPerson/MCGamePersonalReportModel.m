...
@interface MCGamePersonalReportModel ()<ApiManagerCallBackProtocol,ApiManagerProvider,ApiManagerProtocol>
{
...
@implementation MCGamePersonalReportModel
...
- (NSString *)urlPathComponentForManagerWithManager:(ApiBaseManager *)manager{
    ...
    return @"web-api/api/v4/game_personal_report";
...
@implementation MCGamePersonalReportDataModel
+(NSDictionary *)objectClassInArray
{
    return @{
             @"Reportlst" : [MCGamePersonalReportlstModel class],
             @"ReportComm" : [MCGamePersonalReportCommModel class]
             };
}
...
@implementation MCGamePersonalReportlstModel
- (void)setValue:(id)value forUndefinedKey:(NSString *)key{
...
@implementation MCGamePersonalReportCommModel
- (void)setValue:(id)value forUndefinedKey:(NSString *)key{
