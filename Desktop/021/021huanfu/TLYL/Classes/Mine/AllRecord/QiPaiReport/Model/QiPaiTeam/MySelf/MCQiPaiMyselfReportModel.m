...
@interface MCQiPaiMyselfReportModel ()<ApiManagerCallBackProtocol,ApiManagerProvider,ApiManagerProtocol>
{
...
@implementation MCQiPaiMyselfReportModel
...
- (NSString *)urlPathComponentForManagerWithManager:(ApiBaseManager *)manager{
    ...
    return @"web-api/api/v4/game_team_report";
...
@implementation MCQiPaiMyselfReportDataModel
