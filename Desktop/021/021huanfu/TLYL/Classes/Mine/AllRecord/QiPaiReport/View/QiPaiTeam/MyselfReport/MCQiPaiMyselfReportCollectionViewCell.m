//
//  MCQiPaiMyselfReportCollectionViewCell.m
//  TLYL
//
...
@interface MCQiPaiMyselfReportCollectionViewCell()
<
UITableViewDelegate,
...
@property (nonatomic,strong) MCQiPaiMyselfReportDataModel * Mmodel;
@end

@implementation MCQiPaiMyselfReportCollectionViewCell
...
-(void)setData:(NSDictionary *)dic{
    _Mmodel=[MCQiPaiMyselfReportDataModel mj_objectWithKeyValues:dic];
