...
#pragma XXLinkLabel 实现部分

@implementation XXLinkLabel


- (void)setMessageModels:(NSArray<XXLinkLabelModel *> *)messageModels {
    
    _messageModels = messageModels;
    
    NSMutableAttributedString *attrStringM = [[NSMutableAttributedString alloc]init];
    for (XXLinkLabelModel *messageModel in messageModels) {
        // 添加表情
...
#pragma XXLinkLabelModel 实现部分


@implementation XXLinkLabelModel
