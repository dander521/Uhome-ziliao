...
@interface MCClickBonusSettlementModel ()<ApiManagerCallBackProtocol,ApiManagerProvider,ApiManagerProtocol>
{
...
@implementation MCClickBonusSettlementModel
...
- (NSString *)urlPathComponentForManagerWithManager:(ApiBaseManager *)manager{
    ...
    return @"web-api/api/v4/bonus_settlement";
...
- (void)managerCallAPIDidFailedWithManager:(ApiBaseManager *)manager errorCode:(NSString *)errorCode{
    ...
    NSLog(@"er=--分红结算bonus_settlement--%@",errorCode);
}
