...
@interface MCAddSubBonusContractModel ()<ApiManagerCallBackProtocol,ApiManagerProvider,ApiManagerProtocol>
{
...
@implementation MCAddSubBonusContractModel
...
- (NSString *)urlPathComponentForManagerWithManager:(ApiBaseManager *)manager{
    ...
    return @"web-api/api/v4/add_sub_contract";
