//
//  MCBonusOneKeySettlementModel.m
//  TLYL
//
...
@interface MCBonusOneKeySettlementModel ()<ApiManagerCallBackProtocol,ApiManagerProvider,ApiManagerProtocol>
{
...
@implementation MCBonusOneKeySettlementModel
...
- (NSString *)urlPathComponentForManagerWithManager:(ApiBaseManager *)manager{
    ...
    return @"web-api/api/v4/one_key_settlement";
