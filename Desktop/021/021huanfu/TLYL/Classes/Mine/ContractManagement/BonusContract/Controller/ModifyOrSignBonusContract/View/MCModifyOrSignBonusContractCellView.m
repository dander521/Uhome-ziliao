//
//  MCModifyOrSignBonusContractCellView.m
//  TLYL
//
...
@interface MCModifyOrSignBonusContractCellView()
...
@implementation MCModifyOrSignBonusContractCellView
...
-(void)setDataSouce:(MCGetMyAndSubSignBounsContractDetailDataModel *)dataSouce{
    ...
    _DividendRatio.text = [MCContractMgtTool getPercentNumber:dataSouce.DividendRatio];//分红比例
