//
//  MCModifySubBonusContractModel.m
//  TLYL
//
...
@interface MCModifySubBonusContractModel ()<ApiManagerCallBackProtocol,ApiManagerProvider,ApiManagerProtocol>
{
...
@implementation MCModifySubBonusContractModel
...
- (NSString *)urlPathComponentForManagerWithManager:(ApiBaseManager *)manager{
    ...
    return @"web-api/api/v4/modify_sub_contract";
