...
@interface MCMyBonusContractListModel ()<ApiManagerCallBackProtocol,ApiManagerProvider,ApiManagerProtocol>
{
...
@implementation MCMyBonusContractListModel
...
- (NSString *)urlPathComponentForManagerWithManager:(ApiBaseManager *)manager{
    ...
    return @"web-api/api/v4/my_contract_list";
...
@implementation MCMyBonusContractListDataModel
+(NSDictionary *)objectClassInArray
{
    return @{
             @"ContractContentModels" : [MCMyBonusContractListDeatailDataModel class]
...
@implementation MCMyBonusContractListDeatailDataModel
- (void)setValue:(id)value forUndefinedKey:(NSString *)key{
