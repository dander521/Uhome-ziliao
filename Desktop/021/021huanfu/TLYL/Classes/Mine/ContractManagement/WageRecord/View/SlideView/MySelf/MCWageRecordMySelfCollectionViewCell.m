//
//  MCWageRecordMySelfCollectionViewCell.m
//  TLYL
//
...
#import "MCWageRecordMySelfTableViewCell.h"
#import "MCRecordTool.h"
#import <MJRefresh/MJRefresh.h>
#import "MCGetDaywagesThreeRdRecordModel.h"

#define MORENCOUNT 15
@interface MCWageRecordMySelfCollectionViewCell ()
<
UITableViewDelegate,
UITableViewDataSource
>

typedef void(^MCWageRecordMySelfCompeletion)(BOOL result, NSDictionary *data );
...
@implementation MCWageRecordMySelfCollectionViewCell
...
-(void)loadData:(MCWageRecordMySelfCompeletion)compeletion{
    NSDictionary * dic;
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    return [MCWageRecordMySelfTableViewCell computeHeight:nil];
}


- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    
    NSString *reuseIdentifier =[NSString stringWithFormat:@"MCWageRecordMySelfTableViewCell-%ld-%ld",(long)indexPath.section,(long)indexPath.row];
    MCWageRecordMySelfTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:reuseIdentifier];
    if (!cell) {
        cell = [[MCWageRecordMySelfTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseIdentifier];
