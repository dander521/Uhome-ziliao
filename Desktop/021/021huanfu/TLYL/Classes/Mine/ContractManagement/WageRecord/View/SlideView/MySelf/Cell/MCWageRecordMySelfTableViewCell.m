//
//  MCWageRecordMySelfTableViewCell.m
//  TLYL
//
...
@interface MCWageRecordMySelfTableViewCell ()
...
@implementation MCWageRecordMySelfTableViewCell
...
-(void)setDataSource:(MCGetDaywagesThreeRdRecordDetailDataModel *)dataSource{
    
    _dataSource = dataSource;
    _lab1.text = dataSource.User_Name;
    _lab2.text = [MCContractMgtTool getPercentNumber:dataSource.DayWagesRatio];
    _lab3.text = dataSource.DayWagesAmount;
