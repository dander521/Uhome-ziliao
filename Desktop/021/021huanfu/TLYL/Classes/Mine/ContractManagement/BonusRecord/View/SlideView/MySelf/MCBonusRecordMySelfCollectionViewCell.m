//
//  MCBonusRecordMySelfCollectionViewCell.m
//  TLYL
//
...
#import "MCBonusRecordMySelfTableViewCell.h"
...
@interface MCBonusRecordMySelfCollectionViewCell ()
<
UITableViewDelegate,
UITableViewDataSource
>

typedef void(^MCBonusRecordMySelfCompeletion)(BOOL result, NSDictionary *data );
...
@implementation MCBonusRecordMySelfCollectionViewCell
...
-(void)loadData:(MCBonusRecordMySelfCompeletion)compeletion{
    NSDictionary * dic;
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    return [MCBonusRecordMySelfTableViewCell computeHeight:nil];
}


- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    
    NSString *reuseIdentifier =[NSString stringWithFormat:@"MCBonusRecordMySelfTableViewCell-%ld-%ld",(long)indexPath.section,(long)indexPath.row];
    MCBonusRecordMySelfTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:reuseIdentifier];
    if (!cell) {
        cell = [[MCBonusRecordMySelfTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseIdentifier];
