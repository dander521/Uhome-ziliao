...
@interface MCBonusRecordSlideView ()
...
@implementation MCBonusRecordSlideView
...
//        vc.Type=MCPersonReportType_Daily;
//    }else{
//        MCPersonReportViewController * vc =(MCPersonReportViewController *)[UIView MCcurrentViewController];
//        vc.Type=MCPersonReportType_Summary;
//    }
...
-(void)createUICollectionView
{
    ...
    layout.itemSize = CGSizeMake(self.frame.size.width-1, self.frame.size.height-TOPHEIGHT);
    ...
    [_collectionView registerClass:[MCBonusRecordXiaJiCollectionViewCell class]  forCellWithReuseIdentifier:NSStringFromClass([MCBonusRecordXiaJiCollectionViewCell class]) ];
    
    [_collectionView registerClass:[MCBonusRecordMySelfCollectionViewCell class] forCellWithReuseIdentifier:NSStringFromClass([MCBonusRecordMySelfCollectionViewCell class])];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row==0)
    {
        MCBonusRecordXiaJiCollectionViewCell *cell=[collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass([MCBonusRecordXiaJiCollectionViewCell class]) forIndexPath:indexPath];
        _xiaJiCell=cell;
        return cell;
        //汇总
    }else {
        
        MCBonusRecordMySelfCollectionViewCell *cell=[collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass([MCBonusRecordMySelfCollectionViewCell class]) forIndexPath:indexPath];
        _mySelfCell=cell;
        return cell;
    }
