//
//  MCGetMyAndSubDayWagesThreeModel.m
//  TLYL
//
...
//获取自己和下级的日工资契约 （日工资3）
@interface MCGetMyAndSubDayWagesThreeModel ()<ApiManagerCallBackProtocol,ApiManagerProvider,ApiManagerProtocol>
{
...
@implementation MCGetMyAndSubDayWagesThreeModel
...
- (NSString *)urlPathComponentForManagerWithManager:(ApiBaseManager *)manager{
    ...
    return @"web-api/api/v4/my_sub_daywages_3rd";
...
- (void)managerCallAPIDidFailedWithManager:(ApiBaseManager *)manager errorCode:(NSString *)errorCode{
    ...
    NSLog(@"er=--web-api/api/v4/my_sub_daywages_3rd--%@",errorCode);
}
...
@implementation MCGetMyAndSubDayWagesThreeDataModel
+(NSDictionary *)objectClassInArray
{
    return @{
             @"SubordinateDayWagesThree" : [MCMyDayWagesThreeRdDayRuleDataModel class],
             @"MyDayWagesThree" : [MCMyDayWagesThreeRdDayRuleDataModel class],
