...
@interface MCWFExplainViewController ()<UIWebViewDelegate>

@property (nonatomic,strong) UIWebView *webView;

@end

@implementation MCWFExplainViewController
...
- (void)loadLocalHTMLFileToUIWebView{
    ...
    self.title=self.baseWFmodel.czName;
    
    if (_baseWFmodel.LotteryID) {
        NSDictionary * cz_dic=[MCDataTool MC_GetDic_CZHelper];
        MCUserDefinedLotteryCategoriesModel * model=[MCUserDefinedLotteryCategoriesModel mj_objectWithKeyValues:cz_dic[_baseWFmodel.LotteryID]];
        // 获取本地html文件文件路径
        NSString *localHTMLPageName = model.WFExplain;
